...
public class SteamWrapperManager : MonoBehaviour {
#if !DISABLESTEAMWORKS
	protected static bool s_EverInitialized = false;

	protected static SteamWrapperManager s_instance;
	protected static SteamWrapperManager Instance => s_instance;

	[SerializeField] protected SteamBoostrap m_steamBoostrap;
	[SerializeField] private int AppID = 0;
    private string _appIdFilePath = "steam_appid.txt";
